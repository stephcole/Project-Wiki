...
- All your app's templates should be within a directory in your app's directory called templates and then with ANOTHER directory with the same name as your app.
